...
class ProductProvider with ChangeNotifier {
  ...
  List<ProductModel> serchQuery(String catSer, List<ProductModel> passedList) {
    List<ProductModel> catLisSer = passedList
        .where((element) =>
            element.productTitle.toLowerCase().contains(catSer.toLowerCase()))
        .toList();
    return catLisSer;
  }
